...
def generate_markdown_report(snapshot, chat_history, ruled_out, conclusion, output_dir=None):
    ...
    report_lines.append(f"**Report Email**: tep-rca-system@example.com")
    report_lines.append("\n---\n")
    ...
    report_lines.append(f"*Contact: tep-rca-system@example.com*")
...
def generate_pdf_report(snapshot, chat_history, ruled_out, conclusion):
    ...
    try:
        ...
        metadata_data = [
            ...
            ['Contact:', 'tep-rca-system@example.com'],
        ...
        story.append(Paragraph("<i>Contact: tep-rca-system@example.com</i>", normal_style))
